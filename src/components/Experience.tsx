...
const About = () => {
  return (
    <section id="about" className="section-container text-white">
      <h2 className="section-title text-4xl font-sans font-medium mb-9">About Me</h2>
                ...
                <div key={item.id} className="relative pl-16 flex items-start group">
                  ...
                  <Card className="glass-card rounded-xl border-muted shadow-xl group-hover:border-red-500 transition-all w-full">
                    <CardContent className="p-6">
                      ...
                      <h3 className="text-xl font-semibold mb-2 bg-gradient-to-r from-red-600 to-yellow-400 text-transparent bg-clip-text">{item.title}</h3>
